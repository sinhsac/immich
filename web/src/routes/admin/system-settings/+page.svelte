<script lang="ts">
  ...
  import ClassificationSettings from '$lib/components/ClassificationSettings.svelte'; // FORK: classification settings
  ...
  import {
    ...
    mdiServerOutline,
    mdiSync,
    mdiTagMultiple, // FORK: classification icon
    mdiTrashCanOutline,
    mdiUpdate,
    mdiVideoOutline,
  } from '@mdi/js';
  ...
  const settings: Array<{
    ...
    // FORK: Classification settings
    {
      component: ClassificationSettings,
      title: 'Classification',
      subtitle: 'Configure automatic image classification and tagging',
      key: 'classification',
      icon: mdiTagMultiple,
    },
    {
